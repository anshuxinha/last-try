var colorjs = (function (r) {
  ...
  var a = (r, a) => {
    ...
    n = (r, t) => {
      for (
        var e = 4 * t.sample, n = r.length / e, o = { r: 0, g: 0, b: 0 }, g = 0;
        g < r.length;
        g += e
      )
        (o.r += r[g]), (o.g += r[g + 1]), (o.b += r[g + 2]);
      return a(
        [[Math.round(o.r / n), Math.round(o.g / n), Math.round(o.b / n)]],
        t
      );
    },
    o = (r, e) => {
    ...
    g = (r, a, t) =>
      new Promise((e, n) => {
        return ((o = ((r) => ("string" == typeof r ? r : r.src))(a)),
        new Promise((r, a) => {
            ...
            e(
              r(
                ...
                (({
                  ...
                  group: t = 20,
                  sample: e = 10,
                } = {}) => ({ amount: r, format: a, group: t, sample: e }))(t)
              )
            )
          )
          .catch((r) => n(r));
  ...
  return (
    (r.average = (r, a) => g(n, r, a)), (r.prominent = (r, a) => g(o, r, a)), r
  );
})({});
